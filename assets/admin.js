(function(){
  ...
  function updateSerp(){if(!seo||!desc||!slug)return;document.getElementById('serpTitle').textContent=seo.value||title.value||'Article title';document.getElementById('serpDesc').textContent=desc.value||'Add a useful meta description for this article.';document.getElementById('serpUrl').textContent='learnpianokeys.com/blog/'+(slug.value||'article-slug')+'/';updateCount('seoTitle');updateCount('metaDescription');}
