...
- Admin: `/admin/`
- Public guide hub: `/guides/`
- Article URLs: `/guides/<slug>/`
...
7. Confirm the article appears at `/guides/piano-scales-for-beginners-guide/` and on `/guides/`.
...
Publishing generates a static `index.html` page inside the article folder. It also rebuilds the public Guides hub and article sitemap. Unpublishing removes the public HTML file and removes the URL from the article sitemap. Deleting removes the record and any public copy.
